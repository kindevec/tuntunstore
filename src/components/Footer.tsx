...
export const SocialIcons: React.FC = () => (
  <div className="flex items-center gap-3">
    <a 
      ...
      target="_blank" 
      rel="noreferrer" 
      className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/5 flex items-center justify-center text-zinc-400 hover:text-emerald-400 hover:border-emerald-500/30 transition-all cursor-pointer group"
      title="Facebook"
    >
...
export const Footer: React.FC<FooterProps> = ({ onSelectTab, activeTab }) => {
  return (
    <footer id="footer-main" className="relative bg-[#050505] text-zinc-400 text-xs pt-6 pb-20 md:pb-6 px-4 sm:px-6 lg:px-8 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-6">
        ...
        {activeTab === 'home' ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-6 border-b border-white/5">
            {/* Brand Column */}
          ...
          /* En las demás pestañas (Catálogo, Billetera, Pedidos, Perfil, Admin) mostramos la barra superior del footer con los botones de redes */
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 border-b border-white/5">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => onSelectTab('home')}>
              <img src="/logo-transparent.png" alt="TunTun Store Logo" className="w-8 h-8 object-contain" />
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-bold text-zinc-400 uppercase mr-1 hidden xs:inline">Nuestras Redes:</span>
              <SocialIcons />
            </div>
          </div>
        )}

        {/* Bottom copyright row for ALL tabs */}
